...
def get_n_most_similar(model_path, data_path, model_filename):
    print('-- Device -- ')
...
if __name__ == '__main__':
    ...
    get_n_most_similar(model_path=args.model_path, data_path=args.data_path, model_filename=args.filename)
